...
breed [ comburentes comburente ]

breed [ valvulas-admissao valvula-admissao ]
breed [ valvulas-exaustao valvula-exaustao ]

breed [ velas vela ]

breed [ pistoes pistao ]
breed [ virabrequins virabrequim ]
...
to setup
  ...
  set tamanho-do-elemento detalhe-do-desenho

  set-patch-size tamanho-do-elemento
  resize-world -200 / tamanho-do-elemento 200 / tamanho-do-elemento -200 / tamanho-do-elemento 200 / tamanho-do-elemento

  import-pcolors "camara_combustao.png"
...
to go
  ...
  ask pistoes [
   set ycor (-60 / tamanho-do-elemento + (40 / tamanho-do-elemento) * cos (2 * pi * ticks + 180))
  ]
...
to cria-elementos-motor
  create-pistoes 1 [
    set xcor 0
    set ycor -100 / tamanho-do-elemento

    set shape "square"
    set color 2

    set size (200 / tamanho-do-elemento)
  ]
